...
<body>
    <section class="login-section">
        <form action="" method="post" enctype="multipart/form-data">
            <a href="slides.php" style="color: #3c8cc9; font-size:1.2rem" title="Return back to slides"><i class="bi bi-arrow-left-circle-fill"></i></a>
            <h3>Add a slide</h3>
            <div>
                <p style="text-align:left">Upload a image for slides</p>
                <input type="file" name="uploadfile" accept="image/*">
                <input class="button" type="submit" name="add" value="add slide">
            </div>

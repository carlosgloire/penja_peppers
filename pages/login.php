...
<body>
    <section class="login-section">
        <form action="" method="post">
            ...
            <h3>Sign in Here</h3>
            <div>
                <input type="text" name="mail" placeholder="Enter your email address" value="<?=isset($mail)?$mail:""?>">
                <input type="password" placeholder="Enter your password" name="password" value="<?=isset($password)?$password:""?>">
                <p class="forgot">Forgot your password ? <a href="forgot_password.php">Click here</a></p>
                <input class="button" type="submit" name="login" value="Sign in">
                <p class="forgot">Don't you have an account ? <a href="signup.php">sign up here</a></p>
            </div>
        </form>
    </section>
</body>
